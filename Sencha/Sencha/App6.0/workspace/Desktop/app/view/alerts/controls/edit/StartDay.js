//<debug>
console.log(new Date().toLocaleTimeString() + ': Log: Load: WPAKD.view.alerts.controls.edit.StartDay');
//</debug>
Ext.define('WPAKD.view.alerts.controls.edit.StartDay', {
    extend: 'Ext.form.field.ComboBox'
    , alias: 'widget.alertscontrolseditstartday'
