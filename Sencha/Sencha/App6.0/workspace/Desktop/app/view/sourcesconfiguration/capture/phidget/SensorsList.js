//<debug>
console.log(new Date().toLocaleTimeString() + ': Log: Load: WPAKD.view.sourcesconfiguration.capture.phidget.SensorsList');
//</debug>
Ext.define("WPAKD.view.sourcesconfiguration.capture.phidget.SensorsList", {
    extend: 'Ext.grid.Panel',
    alias : 'widget.sourcesconfigurationcapturephidgetsensorslist',

    store: 'sourcesconfiguration.PhidgetPorts',

//    stateful: true,
//    stateId: 'sourcesconfigurationcapturephidgetsensorslist',
...
//    autoScroll: true,
    columns: [
        ...
        {text: i18n.gettext('Type'),    dataIndex: 'NAME',             align: 'left',        width: 120,        sortable: true,
          field: {xtype: 'sourcesconfigurationcapturephidgetphidgetsportslist'},
