/*global Ext, i18n*/
//<debug>
console.log(new Date().toLocaleTimeString() + ": Log: Load: WPAKD.view.sourcesconfiguration.pictures.text.Cfgimgdateformat");
//</debug>
Ext.define("WPAKD.view.sourcesconfiguration.pictures.text.Cfgimgdateformat", {
    extend: "Ext.form.field.ComboBox"
    , alias: "widget.sourcesconfigurationpicturestextcfgimgdateformat"
