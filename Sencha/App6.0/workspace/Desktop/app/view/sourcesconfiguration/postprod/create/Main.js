...
Ext.define("WPAKD.view.sourcesconfiguration.postprod.create.Main", {
    ...
    , items   : [
        ...
        , {
            ...
            , items : [
                {flex: 1,labelWidth: 300, xtype: "sourcesconfigurationpostprodcreatecfgcustomstartdate"     }
            ...
            , layout: {type:"hbox", align: "stretch", pack: "start"}
            , items : [
                {flex: 1,labelWidth: 300, xtype: "sourcesconfigurationpostprodcreatecfgcustomenddate"     }
                , {width: 10,   xtype: "fieldcontainer", fieldLabel: i18n.gettext("at"), labelSeparator: "", padding: "0 5 0 5"  }
            ...
            , layout: {type:"hbox", align: "stretch", pack: "start"}
            , items : [
                {width: 350, labelWidth: 300, xtype : "sourcesconfigurationpostprodcreatecfgcustomkeepstarthour"   }
                , {width: 10,	xtype: "label",	html: ":",                  padding: 2               }
            ...
            , layout: {type:"hbox", align: "stretch", pack: "start"}
            , items   : [
                {width: 350, labelWidth: 300, xtype: "sourcesconfigurationpostprodcreatecfgvidminintervalvalue" }
