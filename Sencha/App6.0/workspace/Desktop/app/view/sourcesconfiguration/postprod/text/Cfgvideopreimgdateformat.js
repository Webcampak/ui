/*global Ext i18n*/
//<debug>
console.log(new Date().toLocaleTimeString() + ": Log: Load: WPAKD.view.sourcesconfiguration.postprod.text.Cfgvideopreimgdateformat");
//</debug>
Ext.define("WPAKD.view.sourcesconfiguration.postprod.text.Cfgvideopreimgdateformat", {
    extend: "Ext.form.field.ComboBox"
    , alias: "widget.sourcesconfigurationpostprodtextcfgvideopreimgdateformat"
