/*global Ext i18n*/
//<debug>
console.log(new Date().toLocaleTimeString() + ": Log: Load: WPAKD.view.sourcesconfiguration.videos.preprocess.Cfgvideopreimgtextgravity");
//</debug>
Ext.define("WPAKD.view.sourcesconfiguration.videos.preprocess.Cfgvideopreimgtextgravity", {
    extend: "Ext.form.field.ComboBox"
    , alias: "widget.sourcesconfigurationvideospreprocesscfgvideopreimgtextgravity"
