/*global Ext, i18n*/
//<debug>
console.log(new Date().toLocaleTimeString() + ": Log: Load: WPAKD.view.sourcesconfiguration.videos.ftp.Cfgftpmainserveraviid");
//</debug>
Ext.define("WPAKD.view.sourcesconfiguration.videos.ftp.Cfgftpmainserveraviid", {
    extend: "Ext.form.ComboBox"
    , alias : "widget.sourcesconfigurationvideosftpcfgftpmainserveraviid"

    , fieldLabel: i18n.gettext("Send AVI video files to")
    ...
    , listeners : {
        change : function(scope, newValue, oldValue) {
            ...
            this.fireEvent("WPAKD.controller.sourcesconfiguration.videos.Videos.updateStoreValue", newValue, oldValue, "cfgftpmainserveraviid");
        }
    }
});