//<debug>
console.log(new Date().toLocaleTimeString() + ': Log: Load: WPAKD.view.sourcesconfiguration.videos.ftp.Cfgftpmainservermp4id');
//</debug>
Ext.define("WPAKD.view.sourcesconfiguration.videos.ftp.Cfgftpmainservermp4id", {
    extend: 'Ext.form.ComboBox'
    , alias : 'widget.sourcesconfigurationvideosftpcfgftpmainservermp4id'

    , fieldLabel: i18n.gettext('Send MP4 files to')
    ...
    , listeners : {
        change : function(scope, newValue, oldValue, eOpts ) {
            ...
            this.fireEvent('WPAKD.controller.sourcesconfiguration.videos.Videos.updateStoreValue', newValue, oldValue, 'cfgftpmainservermp4id');
        }
    }
});